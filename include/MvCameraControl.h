 ...
 *  @brief  Get the optimal Packet Size, the corresponding Gigevision device is SCPS, corresponding to U3V device is the packet size read from the driver each time
 *  @param  void* handle                  [IN]        Camera handle
...
// Callback function when node is need to update
// When call MV_XML_UpdateNodeFeature interface to update node feature, callback function cbUpdate registed will return related nodes in pstNodesList
/***********************************************************************
